...
| <a name="provider_aws.network"></a> [aws.network](#provider\_aws.network) | 5.100.0 |
...
| Name | Description |
|------|-------------|
| <a name="output_tgw_attachment_id"></a> [tgw\_attachment\_id](#output\_tgw\_attachment\_id) | TGW VPC attachment ID for the development spoke |
