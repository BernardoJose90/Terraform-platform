...
| <a name="input_tags"></a> [tags](#input\_tags) | Tags applied to all resources in this account | `map(string)` | <pre>{<br/>  "Environment": "network",<br/>  "ManagedBy": "Terraform"<br/>}</pre> | no |
